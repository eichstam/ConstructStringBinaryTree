...
public class Solution {
  ...
  public String tree2str(TreeNode t) {
    ...
    if(t == null) return treeStr;
    if((t.left == null) && (t.right == null)) {  // leaf node
      treeStr = treeStr + t.val;
    } else if(t.left == null) {
      treeStr = t.val + "()(" + tree2str(t.right) + ")"; 
    } else if(t.right == null){
      treeStr = t.val + "(" + tree2str(t.left) + ")";
    } else {
      treeStr = t.val + "(" + tree2str(t.left) + ")(" + tree2str(t.right) + ")";
    }
